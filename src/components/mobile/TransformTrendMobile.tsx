...
function TransformTrendMobile({
  ...
  /* eslint-disable */
  if (selectOptions && (elements?.nb_visits || elements?.nb_visits === 0)) {
    /* eslint-enable */
    ...
    if (selectOptions[0].value !== '0') {
      ...
      (elements?.nb_visits || elements?.nb_visits === 0) &&
...
export default TransformTrendMobile
